...
const Navbar = () => {
  return (
    <>
      <header className="px-4 pb-4 pt-6 text-gray-800">
        <div className="container flex justify-between h-16 mx-auto rounded-lg bg-indigo-400 p-6">
          ...
          >
          <img src={Logo} className="h-8 w-8" /><p className="text-white tracking-tighter font-semibold text-lg lg:block hidden">EmpHasis.</p>
          </a>
